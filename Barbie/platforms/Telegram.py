...
**ETA:** {eta}"""
            ...
            try:
                ...
                await mystic.edit_text("Successfully Downloaded ...\nProcessing file now ...")
                downloader.pop(message.id)
            except:
                await mystic.edit_text("Failed to download the media from telegram ...")
        ...
        if len(downloader) > 10:
            ...
            try:
                ...
                eta = "Unknown"
            await mystic.edit_text("Bot is **overloaded** with downloads right now ...\n\n**Try After:** {0} (__expected time__)".format(eta))
            return False
